...
### `src/TicketMasala.Web/Services/`

Legacy services directory. This directory is deprecated, and no new code should be added here. Remaining services are being migrated to the `Engine/` subfolders.

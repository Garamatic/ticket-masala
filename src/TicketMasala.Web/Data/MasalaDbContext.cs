...
using TicketMasala.Domain.Entities; // ApplicationUser, Employee stay in Web (Identity concern)
...
public class MasalaDbContext : IdentityDbContext<ApplicationUser, IdentityRole, string>
{
    ...
    public DbSet<Domain.Entities.KnowledgeBaseArticle> KnowledgeBaseArticles { get; set; }
    public DbSet<Domain.Entities.ProjectTemplate> ProjectTemplates { get; set; }
    public DbSet<Domain.Entities.TemplateTicket> TemplateTickets { get; set; }
    public DbSet<Domain.Entities.SavedFilter> SavedFilters { get; set; }
    public DbSet<Domain.Entities.Document> Documents { get; set; }
    public DbSet<Domain.Entities.TicketComment> TicketComments { get; set; }
    public DbSet<Domain.Entities.QualityReview> QualityReviews { get; set; }
    public DbSet<Domain.Entities.Notification> Notifications { get; set; }
    public DbSet<Domain.Entities.AuditLogEntry> AuditLogs { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // These are configured here since ApplicationUser is in Web project
    ...
    private void ConfigureUserRelationships(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TimeLog>()
            .HasOne<TicketMasala.Domain.Entities.ApplicationUser>()
            .WithMany()
